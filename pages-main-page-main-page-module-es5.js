...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-main-page-main-page-module"], {
  ...
  /***/
  function srcAppModulesGeneralComponentsCalculateBlockCalculateBlockComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CalculateBlockComponent", function () {
      return CalculateBlockComponent;
    });
    /* harmony import */
    ...
    var _shared_components_icons_icons_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../../../../shared/components/icons/icons.component */
    "./src/app/shared/components/icons/icons.component.ts");

    var CalculateBlockComponent = /*#__PURE__*/function () {
      function CalculateBlockComponent() {
        _classCallCheck(this, CalculateBlockComponent);
      }

      _createClass(CalculateBlockComponent, [{
        key: "ngOnInit",
    ...
    CalculateBlockComponent.ɵfac = function CalculateBlockComponent_Factory(t) {
      return new (t || CalculateBlockComponent)();
    };

    CalculateBlockComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: CalculateBlockComponent,
      selectors: [["app-calculate-block"]],
      decls: 42,
      vars: 0,
      consts: [[1, "block"], [1, "block__title"], [1, "block__subtitle"], [1, "block__content"], [1, "calculate"], [1, "calculate__border"], [1, "calculate__title", "mui-space_bottom-5"], [1, "progress-empty", "mui-space_bottom-10"], [1, "progress"], [1, "step", "calculate__content"], [1, "step__description", "mui-space_bottom-10"], ["action", "", 1, "step__content"], [1, "chip"], ["type", "radio", 1, "radio"], [1, "calculate__button"], [1, "button-icon"], ["name", "iconArrowRight"], [1, "right-content", "mui-space_left-5"], [1, "line-primary-color"], [1, "right-content__description"]],
      template: function CalculateBlockComponent_Template(rf, ctx) {
        if (rf & 1) {
      ...
      directives: [_shared_components_icons_icons_component__WEBPACK_IMPORTED_MODULE_1__["IconsComponent"]],
      styles: [".block[_ngcontent-%COMP%] {\n  background-image: url('background.png');\n  background-position: center;\n  background-size: cover;\n  background-repeat: no-repeat;\n  color: #000000;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  padding: 130px 0;\n}\n.block__title[_ngcontent-%COMP%] {\n  font-family: \"BerlingskeSerif-BoldItalic\";\n  font-size: 36px;\n  line-height: 43px;\n  text-align: center;\n  max-width: 900px;\n  color: #000000;\n  margin-bottom: 30px;\n}\n.block__subtitle[_ngcontent-%COMP%] {\n  font-family: \"MuseoSansCyrl-100\";\n  font-size: 16px;\n  line-height: 19px;\n  text-align: center;\n  color: #000000;\n  margin-bottom: 85px;\n}\n.block__content[_ngcontent-%COMP%] {\n  display: flex;\n}\n.calculate[_ngcontent-%COMP%] {\n  background: #ffffff;\n  box-shadow: -2px 0px 32px rgba(0, 0, 0, 0.07);\n  border-radius: 6px;\n  width: 800px;\n  height: 600px;\n  padding: 10px;\n}\n.calculate__border[_ngcontent-%COMP%] {\n  background: #ffffff;\n  border: 1px solid #ececec;\n  box-sizing: border-box;\n  box-shadow: -2px 0px 32px rgba(0, 0, 0, 0.07);\n  border-radius: 6px;\n  height: 100%;\n  width: 100%;\n  position: relative;\n  padding: 60px;\n  display: flex;\n  flex-direction: column;\n}\n.calculate__title[_ngcontent-%COMP%] {\n  display: flex;\n  font-family: \"MuseoSansCyrl-100\";\n  font-size: 16px;\n  line-height: 19px;\n  text-align: left;\n  text-transform: uppercase;\n  color: #000000;\n}\n.calculate__content[_ngcontent-%COMP%] {\n  font-family: Berlingske Serif;\n  font-size: 20px;\n  line-height: 24px;\n  text-transform: uppercase;\n  color: #000000;\n}\n.calculate__button[_ngcontent-%COMP%] {\n  background: linear-gradient(180deg, #fbdb74 0%, #e2ac48 100%);\n  box-shadow: 0px 2px 4px rgba(0, 0, 0, 0.25);\n  border-radius: 6px;\n  height: 70px;\n  width: 300px;\n  border: none;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  font-family: \"MuseoSansCyrl-700\";\n  font-size: 12px;\n  line-height: 14px;\n  text-align: center;\n  text-transform: uppercase;\n  color: #000000;\n  padding: 15px 28px;\n  box-sizing: border-box;\n  cursor: pointer;\n  transition: 0.2s ease-in-out;\n}\n.calculate__button[_ngcontent-%COMP%]   .button-icon[_ngcontent-%COMP%] {\n  background: linear-gradient(180deg, #e2ac48 0%, #fada73 100%);\n  border-radius: 50%;\n  width: 40px;\n  height: 40px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n.calculate__button[_ngcontent-%COMP%]:hover {\n  transition: 0.2s ease-in-out;\n  background: linear-gradient(180deg, #fad14c 0%, #dc9c25 100%);\n}\n.progress-empty[_ngcontent-%COMP%] {\n  background: #f3f3f3;\n  border-radius: 6px;\n  width: 570px;\n  height: 12px;\n}\n.progress[_ngcontent-%COMP%] {\n  width: 25%;\n  height: 12px;\n  background: linear-gradient(270deg, #fad875 0%, #edbe7d 100%);\n  border-radius: 6px;\n}\n.right-content[_ngcontent-%COMP%] {\n  width: 343px;\n  height: 600px;\n  background: linear-gradient(180deg, #262b32 0%, #15171a 100%);\n  border-radius: 6px;\n  padding: 85px 45px;\n  box-sizing: border-box;\n}\n.right-content__description[_ngcontent-%COMP%] {\n  font-family: \"BerlingskeSerif\";\n  font-size: 20px;\n  line-height: 24px;\n  text-align: center;\n  text-transform: uppercase;\n  color: #ffffff;\n  padding: 30px 0;\n}\n.line-primary-color[_ngcontent-%COMP%] {\n  background: linear-gradient(270deg, #fad875 10.94%, #edbe7d 66.67%);\n  height: 1px;\n  width: 100%;\n}\n.step__content[_ngcontent-%COMP%] {\n  max-width: 570px;\n  display: flex;\n  justify-content: space-between;\n  flex-wrap: wrap;\n}\n.chip[_ngcontent-%COMP%] {\n  width: 270px;\n  min-height: 50px;\n  display: flex;\n  align-items: center;\n  padding: 16px 26px;\n  font-family: \"MuseoSansCyrl-300\";\n  font-size: 16px;\n  line-height: 19px;\n  color: #000000;\n  border: 1px solid #ececec;\n  box-sizing: border-box;\n  border-radius: 6px;\n  text-transform: none;\n  margin-bottom: 30px;\n}\n.radio[_ngcontent-%COMP%] {\n  display: flex;\n  width: 16px;\n  height: 16px;\n  margin-right: 14px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"],
      changeDetection: 0
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CalculateBlockComponent, [{
  ...
  /***/
  function srcAppModulesGeneralComponentsDesignerOrderBlockDesignerOrderBlockComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DesignerOrderBlockComponent", function () {
      return DesignerOrderBlockComponent;
    });
    /* harmony import */
    ...
    var DesignerOrderBlockComponent = /*#__PURE__*/function () {
      function DesignerOrderBlockComponent() {
        _classCallCheck(this, DesignerOrderBlockComponent);
      }

      _createClass(DesignerOrderBlockComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    DesignerOrderBlockComponent.ɵfac = function DesignerOrderBlockComponent_Factory(t) {
      return new (t || DesignerOrderBlockComponent)();
    };

    DesignerOrderBlockComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: DesignerOrderBlockComponent,
      selectors: [["app-designer-order-block"]],
      decls: 34,
      vars: 0,
      consts: [[1, "block"], [1, "block__content"], [1, "title"], [1, "primary-text-color"], [1, "grid-panel"], [1, "element"], [1, "icon", "mui-space_right-5"], ["name", "iconShield"], [1, "text"], [1, "block__footer"], [1, "button"], [1, "description", "mui-space_left-5"]],
      template: function DesignerOrderBlockComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
      ...
      directives: [_shared_components_icons_icons_component__WEBPACK_IMPORTED_MODULE_1__["IconsComponent"]],
      styles: ["[_nghost-%COMP%] {\n  background-image: url('background2.png');\n  background-position: left;\n  background-size: cover;\n  background-repeat: no-repeat;\n}\n.block[_ngcontent-%COMP%] {\n  min-height: 865px;\n  display: flex;\n  flex-direction: column;\n  padding: 130px 80px;\n  margin-left: 210px;\n}\n.block__content[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n}\n.block__content[_ngcontent-%COMP%]   .title[_ngcontent-%COMP%] {\n  font-family: \"BerlingskeSerif\";\n  font-style: italic;\n  font-weight: 600;\n  font-size: 36px;\n  line-height: 54px;\n  \n  max-width: 957px;\n  text-transform: uppercase;\n  margin-bottom: 130px;\n  color: #fff;\n}\n.block__footer[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  max-width: 747px;\n}\n.grid-panel[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-rows: 72px 72px;\n  grid-template-columns: 365px 365px;\n  grid-gap: 30px;\n  max-width: 790px;\n  margin-bottom: 50px;\n}\n.element[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n}\n.button[_ngcontent-%COMP%] {\n  background: linear-gradient(180deg, #fbdb74 0%, #e2ac48 100%);\n  box-shadow: 0px 2px 4px rgba(0, 0, 0, 0.25);\n  border-radius: 6px;\n  height: 70px;\n  width: 100%;\n  border: none;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  font-family: \"MuseoSansCyrl-700\";\n  font-size: 12px;\n  line-height: 14px;\n  text-transform: uppercase;\n  color: #000000;\n  padding: 15px 28px;\n  box-sizing: border-box;\n  cursor: pointer;\n  transition: 0.2s ease-in-out;\n}\n.button[_ngcontent-%COMP%]:hover {\n  transition: 0.2s ease-in-out;\n  background: linear-gradient(180deg, #fad14c 0%, #dc9c25 100%);\n}\n.description[_ngcontent-%COMP%] {\n  font-family: Museo Sans Cyrl;\n  font-style: normal;\n  font-weight: 600;\n  font-size: 16px;\n  line-height: 19px;\n  color: #ffffff;\n}\n/*# sourceMappingURL=data:application/json;base64, */"],
      changeDetection: 0
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DesignerOrderBlockComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppModulesGeneralComponentsExamplesBlockExamplesBlockComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ExamplesBlockComponent", function () {
      return ExamplesBlockComponent;
    });
    /* harmony import */
    ...
    var ExamplesBlockComponent = /*#__PURE__*/function () {
      function ExamplesBlockComponent() {
        _classCallCheck(this, ExamplesBlockComponent);

        this.slideIndex = [1, 1];
      }

      _createClass(ExamplesBlockComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "plusSlides",
        value: function plusSlides(n, no) {
          this.showSlides(this.slideIndex[no] += n, no);
        }
      }, {
        key: "showSlides",
        value: function showSlides(n, no) {// var i;
    ...
    ExamplesBlockComponent.ɵfac = function ExamplesBlockComponent_Factory(t) {
      return new (t || ExamplesBlockComponent)();
    };

    ExamplesBlockComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: ExamplesBlockComponent,
      selectors: [["app-examples-block"]],
      decls: 32,
      vars: 0,
      consts: [[1, "block"], [1, "block__title"], [1, "primary-text-color"], [1, "slider"], [1, "slider__container"], [1, "slide"], [1, "slide__left-column"], [1, "caption"], [1, "image"], ["width", "100%", "height", "100%", "src", "../../../../../assets/images/IMG1.png", "alt", ""], [1, "slide__right-column"], ["width", "100%", "height", "100%", "src", "../../../../../assets/images/IMG2.png", "alt", ""], ["onclick", "plusSlides(-1)", 1, "slider__prev"], [1, "icon__prev"], ["name", "iconSliderArrowRight"], ["onclick", "plusSlides(1)", 1, "slider__next"], [1, "icon__next"], [1, "slider__dots"], ["onclick", "currentSlide(1)", 1, "dot", "active"], ["onclick", "currentSlide(2)", 1, "dot"], ["onclick", "currentSlide(3)", 1, "dot"], ["onclick", "currentSlide(1)", 1, "dot"]],
      template: function ExamplesBlockComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ExamplesBlockComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppModulesGeneralComponentsGeneralPreviewComponentGeneralPreviewComponentComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "GeneralPreviewComponentComponent", function () {
      return GeneralPreviewComponentComponent;
    });
    /* harmony import */
    ...
    var GeneralPreviewComponentComponent = /*#__PURE__*/function () {
      function GeneralPreviewComponentComponent() {
        _classCallCheck(this, GeneralPreviewComponentComponent);
      }

      _createClass(GeneralPreviewComponentComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    GeneralPreviewComponentComponent.ɵfac = function GeneralPreviewComponentComponent_Factory(t) {
      return new (t || GeneralPreviewComponentComponent)();
    };

    GeneralPreviewComponentComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: GeneralPreviewComponentComponent,
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](GeneralPreviewComponentComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppModulesGeneralComponentsHaulingFurnitureBlockHaulingFurnitureBlockComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "HaulingFurnitureBlockComponent", function () {
      return HaulingFurnitureBlockComponent;
    });
    /* harmony import */
    ...
    var HaulingFurnitureBlockComponent = /*#__PURE__*/function () {
      function HaulingFurnitureBlockComponent() {
        _classCallCheck(this, HaulingFurnitureBlockComponent);
      }

      _createClass(HaulingFurnitureBlockComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    HaulingFurnitureBlockComponent.ɵfac = function HaulingFurnitureBlockComponent_Factory(t) {
      return new (t || HaulingFurnitureBlockComponent)();
    };

    HaulingFurnitureBlockComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: HaulingFurnitureBlockComponent,
      selectors: [["app-hauling-furniture-block"]],
      decls: 2,
      vars: 0,
      template: function HaulingFurnitureBlockComponent_Template(rf, ctx) {
        if (rf & 1) {
      ...
      styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL21vZHVsZXMvZ2VuZXJhbC9jb21wb25lbnRzL2hhdWxpbmctZnVybml0dXJlLWJsb2NrL2hhdWxpbmctZnVybml0dXJlLWJsb2NrLmNvbXBvbmVudC5sZXNzIn0= */"],
      changeDetection: 0
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HaulingFurnitureBlockComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppModulesGeneralComponentsProductionBlockProductionBlockComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ProductionBlockComponent", function () {
      return ProductionBlockComponent;
    });
    /* harmony import */
    ...
    var ProductionBlockComponent = /*#__PURE__*/function () {
      function ProductionBlockComponent() {
        _classCallCheck(this, ProductionBlockComponent);
      }

      _createClass(ProductionBlockComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    ProductionBlockComponent.ɵfac = function ProductionBlockComponent_Factory(t) {
      return new (t || ProductionBlockComponent)();
    };

    ProductionBlockComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: ProductionBlockComponent,
      selectors: [["app-production-block"]],
      decls: 19,
      vars: 0,
      consts: [[1, "container"], [1, "left-column"], [1, "title"], [1, "subtitle"], [1, "right-column"], [1, "video", "mui-space_right-5"], [1, "play"], ["width", "10", "height", "10", "viewBox", "0 0 10 10", "fill", "none", "xmlns", "http://www.w3.org/2000/svg"], ["fill-rule", "evenodd", "clip-rule", "evenodd", "d", "M2.333 0.867012C1.48 0.426012 0.789001 0.787012 0.789001 1.66901V8.19501C0.789001 9.07801 1.48 9.43801 2.333 9.00001L8.675 5.72901C9.529 5.28901 9.529 4.57501 8.675 4.13601L2.333 0.867012Z", "fill", "#111416"], [1, "video"]],
      template: function ProductionBlockComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
      ...
      styles: ["[_nghost-%COMP%] {\n  min-height: 685px;\n  background: #fff;\n  color: #000000;\n  padding-top: 170px;\n  position: relative;\n}\n.container[_ngcontent-%COMP%] {\n  display: flex;\n  max-width: 1172px;\n  margin: 0 auto;\n  align-items: center;\n}\n.container[_ngcontent-%COMP%]   .title[_ngcontent-%COMP%] {\n  font-family: Berlingske Serif;\n  font-style: italic;\n  font-weight: 600;\n  font-size: 36px;\n  line-height: 43px;\n  color: #000000;\n  max-width: 248px;\n}\n.container[_ngcontent-%COMP%]   .video-list[_ngcontent-%COMP%] {\n  display: flex;\n}\n.left-column[_ngcontent-%COMP%] {\n  margin-right: 30px;\n}\n.right-column[_ngcontent-%COMP%] {\n  display: flex;\n}\n.video[_ngcontent-%COMP%] {\n  width: 285px;\n  height: 206px;\n  background: linear-gradient(90deg, #15171a 24.66%, #262b32 100%);\n  border-radius: 6px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n.video[_ngcontent-%COMP%]   .play[_ngcontent-%COMP%] {\n  width: 60px;\n  height: 60px;\n  border-radius: 50%;\n  background: linear-gradient(0deg, #e4a94d 0%, #fcd977 100%);\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n/*# sourceMappingURL=data:application/json;base64, */"],
      changeDetection: 0
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ProductionBlockComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppModulesGeneralComponentsProgressWorkBlockProgressWorkBlockComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ProgressWorkBlockComponent", function () {
      return ProgressWorkBlockComponent;
    });
    /* harmony import */
    ...
    function ProgressWorkBlockComponent_div_5_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var ProgressWorkBlockComponent = /*#__PURE__*/function () {
      function ProgressWorkBlockComponent() {
        _classCallCheck(this, ProgressWorkBlockComponent);
      ...
      _createClass(ProgressWorkBlockComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    ProgressWorkBlockComponent.ɵfac = function ProgressWorkBlockComponent_Factory(t) {
      return new (t || ProgressWorkBlockComponent)();
    };

    ProgressWorkBlockComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: ProgressWorkBlockComponent,
      selectors: [["app-progress-work-block"]],
      decls: 6,
      vars: 1,
      consts: [[1, "block"], [1, "block__content"], [1, "title", "mui-space_bottom-10"], [1, "block__elements"], ["class", "element", 4, "ngFor", "ngForOf"], [1, "element"], [1, "element__content"], [1, "number", "mui-space_bottom-5"], [1, "second"], [1, "line"], [1, "text"]],
      template: function ProgressWorkBlockComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ProgressWorkBlockComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppModulesGeneralComponentsQualityBlockQualityBlockComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "QualityBlockComponent", function () {
      return QualityBlockComponent;
    });
    /* harmony import */
    ...
    var QualityBlockComponent = /*#__PURE__*/function () {
      function QualityBlockComponent() {
        _classCallCheck(this, QualityBlockComponent);
      }

      _createClass(QualityBlockComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    QualityBlockComponent.ɵfac = function QualityBlockComponent_Factory(t) {
      return new (t || QualityBlockComponent)();
    };

    QualityBlockComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: QualityBlockComponent,
      selectors: [["app-quality-block"]],
      decls: 37,
      vars: 0,
      consts: [[1, "container"], [1, "title"], [1, "subtitle"], [1, "form"], [1, "form__content"], [1, "form__title"], [1, "text-lighter"], [1, "text-upper"], [1, "messagers", "mui-space_bottom-2"], [1, "messager"], ["name", "iconTelegrammMessager"], ["name", "iconViberMessager"], ["name", "iconWhatsupMessager"], [1, "text", "mui-space_bottom-2"], [1, "form-action"], ["type", "text", "placeholder", "\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0432\u0430\u0448\u0435 \u0438\u043C\u044F", 1, "input", "mui-space_bottom-1"], ["type", "number", 1, "input", "mui-space_bottom-1"], [1, "add-image"], [1, "add-image__icon"], ["name", "iconAddImage"], [1, "add-image__label"], ["type", "file", 1, "mui-space_bottom-2", 2, "display", "none"], [1, "button"], [1, "underline-text"], [1, "primary-text-color"]],
      template: function QualityBlockComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
      ...
      directives: [_shared_components_icons_icons_component__WEBPACK_IMPORTED_MODULE_1__["IconsComponent"]],
      styles: ["[_nghost-%COMP%] {\n  height: 1100px;\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  padding: 130px 0;\n  background-image: url('Group 191.png');\n  background-size: cover;\n  background-position: center;\n  background-repeat: no-repeat;\n}\n.container[_ngcontent-%COMP%] {\n  max-width: 1080px;\n  margin: 0 auto;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  position: relative;\n}\n.title[_ngcontent-%COMP%] {\n  font-style: italic;\n  font-weight: 600;\n  font-size: 36px;\n  line-height: 43px;\n  text-align: center;\n  margin-bottom: 30px;\n  color: #000000;\n}\n.subtitle[_ngcontent-%COMP%] {\n  font-family: \"BerlingskeSerif\";\n  font-style: normal;\n  font-weight: 600;\n  font-size: 16px;\n  line-height: 19px;\n  text-align: center;\n  text-transform: uppercase;\n  color: #000000;\n}\n.form[_ngcontent-%COMP%] {\n  background-image: url('Component19.png');\n  background-repeat: no-repeat;\n  background-size: cover;\n  background-position: center;\n  position: absolute;\n  top: 150%;\n  right: 0;\n  width: 310px;\n  height: 560px;\n  border-radius: 6px;\n  padding: 8px;\n}\n.form__content[_ngcontent-%COMP%] {\n  border-radius: 6px;\n  box-sizing: border-box;\n  color: #000000;\n  width: 100%;\n  height: 100%;\n  padding: 40px 40px 28px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: space-between;\n}\n.form__title[_ngcontent-%COMP%] {\n  font-family: Berlingske Serif;\n  font-style: italic;\n  font-weight: 600;\n  font-size: 20px;\n  line-height: 30px;\n  \n  display: flex;\n  align-items: center;\n  text-align: center;\n  color: #000000;\n  margin-bottom: 8px;\n}\n.text-lighter[_ngcontent-%COMP%] {\n  font-family: \"MuseoSansCyrl-300\";\n  font-size: 14px;\n  line-height: 16px;\n  display: flex;\n  align-items: center;\n  text-align: center;\n  color: #939391;\n  margin-bottom: 20px;\n}\n.text-upper[_ngcontent-%COMP%] {\n  font-family: \"MuseoSansCyrl-300\";\n  font-size: 10px;\n  line-height: 16px;\n  display: flex;\n  align-items: center;\n  text-align: center;\n  text-transform: uppercase;\n  color: #000000;\n  margin-bottom: 8px;\n}\n.messagers[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-around;\n  width: 100%;\n}\n.messager[_ngcontent-%COMP%] {\n  width: 43px;\n  height: 43px;\n  display: flex;\n  justify-items: center;\n  align-items: center;\n}\n.text[_ngcontent-%COMP%] {\n  font-family: \"MuseoSansCyrl-300\";\n  font-size: 10px;\n  line-height: 16px;\n  display: flex;\n  align-items: center;\n  color: #939391;\n  text-align: center;\n  justify-content: center;\n}\n.add-image[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n}\n.add-image__icon[_ngcontent-%COMP%] {\n  width: 40px;\n  height: 40px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  background-color: #fafafa;\n  border-radius: 6px;\n  margin-right: 20px;\n  -webkit-clip-path: polygon(98% 0, 100% 25%, 100% 75%, 98% 100%, 2% 100%, 0 75%, 0 25%, 2% 0);\n          clip-path: polygon(98% 0, 100% 25%, 100% 75%, 98% 100%, 2% 100%, 0 75%, 0 25%, 2% 0);\n}\n.add-image__label[_ngcontent-%COMP%] {\n  font-family: \"MuseoSansCyrl-300\";\n  font-size: 10px;\n  line-height: 16px;\n  display: flex;\n  align-items: center;\n  text-align: center;\n  color: #000000;\n}\n.input[_ngcontent-%COMP%] {\n  padding: 16px 24px;\n  width: 100%;\n  justify-content: center;\n  font-family: \"MuseoSansCyrl\";\n  font-style: normal;\n  font-weight: normal;\n  font-size: 10px;\n  line-height: 16px;\n  display: flex;\n  align-items: center;\n  text-align: center;\n  color: #000000;\n  background-color: #fafafa;\n  outline: none;\n  border: none;\n  -webkit-clip-path: polygon(98% 0, 100% 25%, 100% 75%, 98% 100%, 2% 100%, 0 75%, 0 25%, 2% 0);\n          clip-path: polygon(98% 0, 100% 25%, 100% 75%, 98% 100%, 2% 100%, 0 75%, 0 25%, 2% 0);\n}\n.button[_ngcontent-%COMP%] {\n  -webkit-clip-path: polygon(98% 0, 100% 25%, 100% 75%, 98% 100%, 2% 100%, 0 75%, 0 25%, 2% 0);\n          clip-path: polygon(98% 0, 100% 25%, 100% 75%, 98% 100%, 2% 100%, 0 75%, 0 25%, 2% 0);\n  width: 100%;\n  background: linear-gradient(180deg, #fbdb74 3.65%, #e2ac48 97.92%);\n  box-shadow: 0px 2px 4px rgba(0, 0, 0, 0.25);\n  border-radius: 6px;\n  font-family: \"MuseoSansCyrl\";\n  font-style: normal;\n  font-weight: 600;\n  font-size: 14px;\n  line-height: 18px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  color: #000000;\n  border: none;\n  outline: none;\n  padding: 16px 48px;\n  border-radius: 8px;\n  cursor: pointer;\n  transition: 0.2s ease-in-out;\n}\n.underline-text[_ngcontent-%COMP%] {\n  font-family: \"MuseoSansCyrl-300\";\n  font-size: 10px;\n  line-height: 16px;\n  display: inline-block;\n  align-items: center;\n  text-align: center;\n  color: #939391;\n  max-width: 196px;\n}\n.form-action[_ngcontent-%COMP%] {\n  margin-bottom: 8px;\n  width: 100%;\n}\n/*# sourceMappingURL=data:application/json;base64, */"],
      changeDetection: 0
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](QualityBlockComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppModulesGeneralComponentsRecomendedBlockRecomendedBlockComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "RecomendedBlockComponent", function () {
      return RecomendedBlockComponent;
    });
    /* harmony import */
    ...
    var _shared_components_icons_icons_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../../../../shared/components/icons/icons.component */
    "./src/app/shared/components/icons/icons.component.ts");

    function RecomendedBlockComponent_div_17_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var RecomendedBlockComponent = /*#__PURE__*/function () {
      function RecomendedBlockComponent() {
        _classCallCheck(this, RecomendedBlockComponent);
      ...
      _createClass(RecomendedBlockComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    RecomendedBlockComponent.ɵfac = function RecomendedBlockComponent_Factory(t) {
      return new (t || RecomendedBlockComponent)();
    };

    RecomendedBlockComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: RecomendedBlockComponent,
      selectors: [["app-recomended-block"]],
      decls: 55,
      vars: 4,
      consts: [[1, "container"], [1, "title-page"], [1, "primary-text-color"], [1, "underline-text"], [1, "slider"], [1, "slider__container"], [1, "slide"], [1, "slide__left-column"], [1, "galery"], [1, "main-image", 3, "ngStyle"], [1, "subimages"], ["class", "subimage", 3, "style", 4, "ngFor", "ngForOf"], [1, "slide__right-column"], [1, "right-group"], [1, "icon"], [1, "slider-title"], [1, "group"], [1, "line"], [1, "tab-group"], [1, "tab"], [1, "description"], [1, "button"], [1, "button-icon"], ["width", "11", "height", "11", "viewBox", "0 0 11 11", "fill", "none", "xmlns", "http://www.w3.org/2000/svg"], ["fill-rule", "evenodd", "clip-rule", "evenodd", "d", "M1.99701 0.243999C0.897012 -0.325001 0.00601196 0.140999 0.00601196 1.283V9.708C0.00601196 10.85 0.897012 11.316 1.99701 10.748L10.169 6.525C11.269 5.957 11.269 5.036 10.169 4.468L1.99701 0.243999Z", "fill", "#111416"], ["onclick", "plusSlides(-1)", 1, "slider__prev"], [1, "icon__prev"], ["name", "iconSliderArrowRight"], ["onclick", "plusSlides(1)", 1, "slider__next"], [1, "icon__next"], [1, "slider__dots"], ["onclick", "currentSlide(1)", 1, "dot", "active"], ["onclick", "currentSlide(2)", 1, "dot"], ["onclick", "currentSlide(3)", 1, "dot"], ["onclick", "currentSlide(1)", 1, "dot"], [1, "subimage"]],
      template: function RecomendedBlockComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["NgStyle"], _angular_common__WEBPACK_IMPORTED_MODULE_1__["NgForOf"], _shared_components_icons_icons_component__WEBPACK_IMPORTED_MODULE_2__["IconsComponent"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RecomendedBlockComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppModulesGeneralComponentsResponsibilityBlockResponsibilityBlockComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ResponsibilityBlockComponent", function () {
      return ResponsibilityBlockComponent;
    });
    /* harmony import */
    ...
    var ResponsibilityBlockComponent = /*#__PURE__*/function () {
      function ResponsibilityBlockComponent() {
        _classCallCheck(this, ResponsibilityBlockComponent);
      }

      _createClass(ResponsibilityBlockComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    ResponsibilityBlockComponent.ɵfac = function ResponsibilityBlockComponent_Factory(t) {
      return new (t || ResponsibilityBlockComponent)();
    };

    ResponsibilityBlockComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: ResponsibilityBlockComponent,
      selectors: [["app-responsibility-block"]],
      decls: 40,
      vars: 0,
      consts: [[1, "block"], [1, "block__content"], [1, "title"], [1, "primary-text-color"], [1, "grid-panel"], [1, "element"], [1, "icon", "mui-space_right-5"], ["name", "iconShield"], [1, "text"], [1, "text__title"], [1, "description"]],
      template: function ResponsibilityBlockComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
      ...
      directives: [_shared_components_icons_icons_component__WEBPACK_IMPORTED_MODULE_1__["IconsComponent"]],
      styles: ["[_nghost-%COMP%] {\n  background-image: url('background1.png');\n  background-position: left;\n  background-size: cover;\n  background-repeat: no-repeat;\n}\n.block[_ngcontent-%COMP%] {\n  min-height: 749px;\n  display: flex;\n  flex-direction: column;\n  padding: 120px 80px;\n  margin-left: 210px;\n}\n.block__content[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n}\n.block__content[_ngcontent-%COMP%]   .title[_ngcontent-%COMP%] {\n  font-family: \"BerlingskeSerif-Italic\";\n  font-size: 36px;\n  line-height: 54px;\n  max-width: 957px;\n  text-transform: uppercase;\n  margin-bottom: 96px;\n  color: #fff;\n}\n.block__footer[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  max-width: 747px;\n}\n.grid-panel[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-rows: 94px 94px;\n  grid-template-columns: 283px 283px;\n  grid-gap: 30px;\n  max-width: 790px;\n  margin-bottom: 50px;\n}\n.element[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n}\n.button[_ngcontent-%COMP%] {\n  background: linear-gradient(180deg, #fbdb74 0%, #e2ac48 100%);\n  box-shadow: 0px 2px 4px rgba(0, 0, 0, 0.25);\n  border-radius: 6px;\n  height: 70px;\n  width: 100%;\n  border: none;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  font-family: \"MuseoSansCyrl-700\";\n  font-size: 12px;\n  line-height: 14px;\n  text-transform: uppercase;\n  color: #000000;\n  padding: 15px 28px;\n  box-sizing: border-box;\n  cursor: pointer;\n  transition: 0.2s ease-in-out;\n}\n.button[_ngcontent-%COMP%]:hover {\n  transition: 0.2s ease-in-out;\n  background: linear-gradient(180deg, #fad14c 0%, #dc9c25 100%);\n}\n.description[_ngcontent-%COMP%] {\n  font-family: Museo Sans Cyrl;\n  font-style: normal;\n  font-weight: 600;\n  font-size: 16px;\n  line-height: 19px;\n  color: #ffffff;\n}\n.text__title[_ngcontent-%COMP%] {\n  font-family: Berlingske Serif;\n  font-style: normal;\n  font-weight: normal;\n  font-size: 14px;\n  line-height: 24px;\n  \n  text-transform: uppercase;\n  \n  color: #fad875;\n  margin-bottom: 4px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"],
      changeDetection: 0
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ResponsibilityBlockComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppModulesGeneralComponentsSocialBlockSocialBlockComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SocialBlockComponent", function () {
    ...
    var SocialBlockComponent = /*#__PURE__*/function () {
      function SocialBlockComponent() {
        _classCallCheck(this, SocialBlockComponent);
      }

      _createClass(SocialBlockComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    SocialBlockComponent.ɵfac = function SocialBlockComponent_Factory(t) {
      return new (t || SocialBlockComponent)();
    };

    SocialBlockComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: SocialBlockComponent,
      selectors: [["app-social-block"]],
      decls: 2,
      vars: 0,
      template: function SocialBlockComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "social-block works!");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        }
      },
      styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL21vZHVsZXMvZ2VuZXJhbC9jb21wb25lbnRzL3NvY2lhbC1ibG9jay9zb2NpYWwtYmxvY2suY29tcG9uZW50Lmxlc3MifQ== */"],
      changeDetection: 0
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SocialBlockComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppModulesGeneralGeneralContentModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "GeneralContentModule", function () {
      return GeneralContentModule;
    });
    /* harmony import */
    ...
    var _components_general_preview_component_general_preview_component_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./components/general-preview-component/general-preview-component.component */
    "./src/app/modules/general/components/general-preview-component/general-preview-component.component.ts");
    /* harmony import */


    var _components_calculate_block_calculate_block_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./components/calculate-block/calculate-block.component */
    "./src/app/modules/general/components/calculate-block/calculate-block.component.ts");
    /* harmony import */


    var _components_designer_order_block_designer_order_block_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./components/designer-order-block/designer-order-block.component */
    "./src/app/modules/general/components/designer-order-block/designer-order-block.component.ts");
    /* harmony import */


    var _components_progress_work_block_progress_work_block_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./components/progress-work-block/progress-work-block.component */
    "./src/app/modules/general/components/progress-work-block/progress-work-block.component.ts");
    /* harmony import */


    var _components_responsibility_block_responsibility_block_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./components/responsibility-block/responsibility-block.component */
    "./src/app/modules/general/components/responsibility-block/responsibility-block.component.ts");
    /* harmony import */


    var _components_production_block_production_block_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./components/production-block/production-block.component */
    "./src/app/modules/general/components/production-block/production-block.component.ts");
    /* harmony import */


    var _components_examples_block_examples_block_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./components/examples-block/examples-block.component */
    "./src/app/modules/general/components/examples-block/examples-block.component.ts");
    /* harmony import */


    var _components_social_block_social_block_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./components/social-block/social-block.component */
    "./src/app/modules/general/components/social-block/social-block.component.ts");
    /* harmony import */


    var _components_quality_block_quality_block_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./components/quality-block/quality-block.component */
    "./src/app/modules/general/components/quality-block/quality-block.component.ts");
    /* harmony import */


    var _components_recomended_block_recomended_block_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./components/recomended-block/recomended-block.component */
    "./src/app/modules/general/components/recomended-block/recomended-block.component.ts");
    /* harmony import */


    var _components_hauling_furniture_block_hauling_furniture_block_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./components/hauling-furniture-block/hauling-furniture-block.component */
    "./src/app/modules/general/components/hauling-furniture-block/hauling-furniture-block.component.ts");

    var GeneralContentModule = function GeneralContentModule() {
      _classCallCheck(this, GeneralContentModule);
    };

    GeneralContentModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
      type: GeneralContentModule
    });
    GeneralContentModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      factory: function GeneralContentModule_Factory(t) {
        return new (t || GeneralContentModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _shared_components_icons_icons_module__WEBPACK_IMPORTED_MODULE_0__["IconsModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](GeneralContentModule, {
        declarations: [_components_general_preview_component_general_preview_component_component__WEBPACK_IMPORTED_MODULE_3__["GeneralPreviewComponentComponent"], _components_calculate_block_calculate_block_component__WEBPACK_IMPORTED_MODULE_4__["CalculateBlockComponent"], _components_designer_order_block_designer_order_block_component__WEBPACK_IMPORTED_MODULE_5__["DesignerOrderBlockComponent"], _components_progress_work_block_progress_work_block_component__WEBPACK_IMPORTED_MODULE_6__["ProgressWorkBlockComponent"], _components_responsibility_block_responsibility_block_component__WEBPACK_IMPORTED_MODULE_7__["ResponsibilityBlockComponent"], _components_production_block_production_block_component__WEBPACK_IMPORTED_MODULE_8__["ProductionBlockComponent"], _components_examples_block_examples_block_component__WEBPACK_IMPORTED_MODULE_9__["ExamplesBlockComponent"], _components_social_block_social_block_component__WEBPACK_IMPORTED_MODULE_10__["SocialBlockComponent"], _components_quality_block_quality_block_component__WEBPACK_IMPORTED_MODULE_11__["QualityBlockComponent"], _components_recomended_block_recomended_block_component__WEBPACK_IMPORTED_MODULE_12__["RecomendedBlockComponent"], _components_hauling_furniture_block_hauling_furniture_block_component__WEBPACK_IMPORTED_MODULE_13__["HaulingFurnitureBlockComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _shared_components_icons_icons_module__WEBPACK_IMPORTED_MODULE_0__["IconsModule"]],
        exports: [_components_general_preview_component_general_preview_component_component__WEBPACK_IMPORTED_MODULE_3__["GeneralPreviewComponentComponent"], _components_calculate_block_calculate_block_component__WEBPACK_IMPORTED_MODULE_4__["CalculateBlockComponent"], _components_designer_order_block_designer_order_block_component__WEBPACK_IMPORTED_MODULE_5__["DesignerOrderBlockComponent"], _components_progress_work_block_progress_work_block_component__WEBPACK_IMPORTED_MODULE_6__["ProgressWorkBlockComponent"], _components_responsibility_block_responsibility_block_component__WEBPACK_IMPORTED_MODULE_7__["ResponsibilityBlockComponent"], _components_production_block_production_block_component__WEBPACK_IMPORTED_MODULE_8__["ProductionBlockComponent"], _components_examples_block_examples_block_component__WEBPACK_IMPORTED_MODULE_9__["ExamplesBlockComponent"], _components_social_block_social_block_component__WEBPACK_IMPORTED_MODULE_10__["SocialBlockComponent"], _components_quality_block_quality_block_component__WEBPACK_IMPORTED_MODULE_11__["QualityBlockComponent"], _components_recomended_block_recomended_block_component__WEBPACK_IMPORTED_MODULE_12__["RecomendedBlockComponent"], _components_hauling_furniture_block_hauling_furniture_block_component__WEBPACK_IMPORTED_MODULE_13__["HaulingFurnitureBlockComponent"]]
      });
    })();
    /*@__PURE__*/
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](GeneralContentModule, [{
  ...
  function srcAppPagesFabricCatalogPageFabricCatalogPageComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    FabricCatalogPageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3BhZ2VzL2ZhYnJpYy1jYXRhbG9nLXBhZ2UvZmFicmljLWNhdGFsb2ctcGFnZS5jb21wb25lbnQubGVzcyJ9 */"],
      changeDetection: 0
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](FabricCatalogPageComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
    ...
    var routes = [{
      ...
      children: [{
        ...
        loadChildren: function loadChildren() {
          ...
          /*! import() | general-page-general-page-module */
          "general-page-general-page-module").then(__webpack_require__.bind(null,
          /*! ../general-page/general-page.module */
          "./src/app/pages/general-page/general-page.module.ts")).then(function (m) {
  ...
  function srcAppPagesMainPageMainPageComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_mock_sidebar_menu_items__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../../shared/mock/sidebar-menu-items */
    ...
    MainPageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 2,
      vars: 1,
      consts: [[1, "header-block", 3, "menuItems"]],
  ...
  function srcAppPagesMainPageMainPageModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _fabric_catalog_page_fabric_catalog_page_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../fabric-catalog-page/fabric-catalog-page.component */
    "./src/app/pages/fabric-catalog-page/fabric-catalog-page.component.ts");
    /* harmony import */
    ...
    MainPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], _main_page_routing_module__WEBPACK_IMPORTED_MODULE_2__["MainPageRoutingModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](MainPageModule, {
        declarations: [_main_page_component__WEBPACK_IMPORTED_MODULE_3__["MainPageComponent"], _fabric_catalog_page_fabric_catalog_page_component__WEBPACK_IMPORTED_MODULE_4__["FabricCatalogPageComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], _main_page_routing_module__WEBPACK_IMPORTED_MODULE_2__["MainPageRoutingModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppSharedComponentsCompanyLogoCompanyLogoComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CompanyLogoComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppSharedComponentsCompanyLogoCompanyLogoModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CompanyLogoModule", function () {
      return CompanyLogoModule;
    });
    /* harmony import */
    ...
    var _company_logo_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./company-logo.component */
    "./src/app/shared/components/company-logo/company-logo.component.ts");

    var CompanyLogoModule = function CompanyLogoModule() {
      _classCallCheck(this, CompanyLogoModule);
    };

    CompanyLogoModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: CompanyLogoModule
    });
    CompanyLogoModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function CompanyLogoModule_Factory(t) {
        return new (t || CompanyLogoModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](CompanyLogoModule, {
        declarations: [_company_logo_component__WEBPACK_IMPORTED_MODULE_2__["CompanyLogoComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"]],
        exports: [_company_logo_component__WEBPACK_IMPORTED_MODULE_2__["CompanyLogoComponent"]]
      });
    })();
    /*@__PURE__*/
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CompanyLogoModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
        args: [{
          declarations: [_company_logo_component__WEBPACK_IMPORTED_MODULE_2__["CompanyLogoComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"]],
  ...
  function srcAppSharedComponentsHeaderHeaderComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _company_logo_company_logo_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../company-logo/company-logo.component */
    "./src/app/shared/components/company-logo/company-logo.component.ts");
    /* harmony import */
    ...
    var _modules_general_components_general_preview_component_general_preview_component_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../../../modules/general/components/general-preview-component/general-preview-component.component */
    "./src/app/modules/general/components/general-preview-component/general-preview-component.component.ts");
    /* harmony import */
    ...
    function HeaderComponent_div_14_div_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function HeaderComponent_div_14_ng_container_5_div_1_div_1_Template(rf, ctx) {
      if (rf & 1) {
        var _r12 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 34);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HeaderComponent_div_14_ng_container_5_div_1_div_1_Template_div_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r12);

          var subItemIndex_r9 = ctx.index;

          var menuItem_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](3).$implicit;

          var ctx_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r10.toggleActive(subItemIndex_r9, menuItem_r2.children);
        });
      ...
      if (rf & 2) {
        var menuSubItem_r8 = ctx.$implicit;
    ...
    function HeaderComponent_div_14_ng_container_5_div_1_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var menuItem_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2).$implicit;
    ...
    function HeaderComponent_div_14_ng_container_5_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function HeaderComponent_div_14_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HeaderComponent_div_14_Template_div_click_1_listener() {
          ...
          return ctx_r15.toggleActive(itemIndex_r3, ctx_r15.menuItems);
        });
    ...
    function HeaderComponent_a_29_Template(rf, ctx) {
      ...
      if (rf & 2) {
        var homePageMenuItem_r17 = ctx.$implicit;
    ...
    HeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 33,
      vars: 2,
      consts: [[1, "container"], [1, "left-column"], [1, "first-block"], [1, "logo"], [1, "title-logo"], [1, "second-block"], [1, "underline-gradient"], [1, "flex", "menu-container"], ["name", "iconLeftMenuBurger", 1, "icon"], [1, "menu-list"], ["class", "menu-item", 4, "ngFor", "ngForOf"], [1, "right-column"], [1, "header-panel"], [1, "header-panel__left"], [1, "header-panel__right"], ["href", "tel:+74957491493", 1, "mobile"], [1, "address"], [1, "address__icon"], ["name", "iconPinAddress"], [1, "address__description"], [1, "underline-gradient-left"], [1, "menu-panel"], ["class", "homepage__menuItem", 4, "ngFor", "ngForOf"], [1, "activeUnderline"], [1, "content"], [1, "menu-item"], [1, "menu-list__link", 3, "ngClass", "click"], ["class", "menu-list__link--item", 4, "ngIf"], [1, "link", 3, "routerLink"], [4, "ngIf"], [1, "menu-list__link--item"], ["id", "menu", "class", "menu-subitem-list", 4, "ngIf"], ["id", "menu", 1, "menu-subitem-list"], ["class", "menu-subitem-list__item", 3, "ngClass", "click", 4, "ngFor", "ngForOf"], [1, "menu-subitem-list__item", 3, "ngClass", "click"], [1, "homepage__menuItem"]],
  ...
  function srcAppSharedComponentsHeaderHeaderModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _modules_general_general_content_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! ./../../../modules/general/general-content.module */
    "./src/app/modules/general/general-content.module.ts");
    /* harmony import */
    ...
    var _company_logo_company_logo_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../company-logo/company-logo.module */
    "./src/app/shared/components/company-logo/company-logo.module.ts");
    /* harmony import */
    ...
    */
    ...
    HeaderModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"], _company_logo_company_logo_module__WEBPACK_IMPORTED_MODULE_5__["CompanyLogoModule"], _icons_icons_module__WEBPACK_IMPORTED_MODULE_6__["IconsModule"], _modules_general_general_content_module__WEBPACK_IMPORTED_MODULE_0__["GeneralContentModule"]]]
    });
  ...
  /***/
  function srcAppSharedComponentsIconsIconsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function IconsComponent__svg_svg_0_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnamespaceSVG"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "svg", 8);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](1, "line", 9);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](2, "line", 10);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](3, "line", 11);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
      }
    }

    function IconsComponent__svg_svg_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnamespaceSVG"]();
    ...
    function IconsComponent__svg_svg_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnamespaceSVG"]();
    ...
    function IconsComponent__svg_svg_3_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnamespaceSVG"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "svg", 16);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "g", 17);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](4, "linearGradient", 19);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](5, "stop", 20);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](6, "stop", 21);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](7, "clipPath", 22);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](8, "rect", 23);
    ...
    function IconsComponent__svg_svg_4_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnamespaceSVG"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](4, "linearGradient", 27);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](7, "linearGradient", 28);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](8, "stop", 29);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](9, "stop", 30);
    ...
    function IconsComponent__svg_svg_5_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnamespaceSVG"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](5, "linearGradient", 33);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](6, "stop", 20);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](7, "stop", 21);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](8, "linearGradient", 34);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](11, "clipPath", 22);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](12, "rect", 35);
    ...
    function IconsComponent__svg_svg_6_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnamespaceSVG"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](3, "rect", 39);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
      }
    }

    function IconsComponent__svg_svg_7_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnamespaceSVG"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](2, "rect", 41);
    ...
    function IconsComponent__svg_svg_8_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnamespaceSVG"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](3, "rect", 46);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
      }
    }

    function IconsComponent__svg_svg_9_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnamespaceSVG"]();
  ...
  /***/
  function srcAppSharedComponentsIconsIconsModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppSharedMockSidebarMenuItemsTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SIDEBAR_MENU_ITEMS", function () {
  ...
  function srcAppSharedSharedModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_header_header_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! ./components/header/header.module */
    "./src/app/shared/components/header/header.module.ts");
    /* harmony import */


    var _components_company_logo_company_logo_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./components/company-logo/company-logo.module */
    "./src/app/shared/components/company-logo/company-logo.module.ts");
    /* harmony import */
    ...
    var MODULES = [_components_company_logo_company_logo_module__WEBPACK_IMPORTED_MODULE_1__["CompanyLogoModule"], _components_header_header_module__WEBPACK_IMPORTED_MODULE_0__["HeaderModule"]];
    ...
    SharedModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"], MODULES], _components_company_logo_company_logo_module__WEBPACK_IMPORTED_MODULE_1__["CompanyLogoModule"], _components_header_header_module__WEBPACK_IMPORTED_MODULE_0__["HeaderModule"]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](SharedModule, {
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"], _components_company_logo_company_logo_module__WEBPACK_IMPORTED_MODULE_1__["CompanyLogoModule"], _components_header_header_module__WEBPACK_IMPORTED_MODULE_0__["HeaderModule"]],
        exports: [_components_company_logo_company_logo_module__WEBPACK_IMPORTED_MODULE_1__["CompanyLogoModule"], _components_header_header_module__WEBPACK_IMPORTED_MODULE_0__["HeaderModule"]]
      });
    })();
    /*@__PURE__*/
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵsetClassMetadata"](SharedModule, [{
        ...
        args: [{
          declarations: [],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"], MODULES],
          exports: [MODULES]
        }]
      }], null, null);
    })();
